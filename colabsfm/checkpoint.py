...
class CheckPoint:
    ...
    def save(
        ...
        if colabsfm.RANK == 0:
            ...
            torch.save(states, os.path.join(self.dir,self.name + f"_latest.pth"))
    ...
    def load(
        ...
        if os.path.exists(os.path.join(self.dir, self.name + f"_latest.pth")) and colabsfm.RANK == 0:
            states = torch.load(os.path.join(self.dir, self.name + f"_latest.pth"))
            if "model" in states:
