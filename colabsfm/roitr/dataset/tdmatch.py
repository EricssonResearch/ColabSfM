...
from .common import collect_local_neighbors, build_ppf_patch, farthest_point_subsampling,\
...
class TDMatchDataset(data.Dataset):
    ...
    def __init__(self, infos, config, data_augmentation=True):
        ...
        self.points_lim = 16_000 if config.mode == 'train' else 30_000
    ...
    def __getitem__(self, index):
        ...
        ##################################################################################################
        # Normal estimation
        #from colabsfm.utils import least_squares_normal_est
        ...
        return src_pcd.astype(np.float32), tgt_pcd.astype(np.float32), \
               ...
               src_pcd.astype(np.float32), None, src_path, tgt_path
