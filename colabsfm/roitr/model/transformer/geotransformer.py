...
from .positional_encoding import GeometricStructureEmbedding
from .geoattention import RPETransformerLayer, TransformerLayer
...
class GeometricTransformer(nn.Module):
    def __init__(
        ...
        activation_fn='ReLU',
        reduction_a='max',
        ppf_mode = "baseline",# TODO: currently not used?
    ):
