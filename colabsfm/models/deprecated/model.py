...
from colabsfm.utils import get_correspondences, estimate_normals
from colabsfm.solvers import SVDSOPPSolver
...
class OmniGlue(nn.Module):
    ...
    def _forward(self, data: dict, score_threshold = -3) -> dict:
        ...
        if "is_ragged" in data:
            from colabsfm.utils import pad_to_length_ragged
