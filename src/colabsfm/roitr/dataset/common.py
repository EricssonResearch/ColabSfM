...
def collate_fn(list_data, config):
    ...
    for ind, (src_pcd, tgt_pcd, src_normals, tgt_normals, src_feats, tgt_feats, rot, trans, raw_src_pcd, metric_index, src_path, tgt_path) in enumerate(list_data):
    ...
    inputs = {
        ...
        'src_paths': src_path,#TODO: these are not batched
        'tgt_paths': tgt_path,
