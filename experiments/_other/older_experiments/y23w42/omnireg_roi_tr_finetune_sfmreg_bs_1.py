...
def main():
    ...
    config['root'] = args.data_root + "/colabsfm/pointclouds"
    ...
    config['snapshot_dir'] = '{}/{}'.format(args.data_root, config['exp_dir'])
    config['tboard_dir'] = '{}/{}/tensorboard'.format(args.data_root, config['exp_dir'])
    config['save_dir'] = '{}/{}/checkpoints'.format(args.data_root, config['exp_dir'])
    config['visual_dir'] = '{}/{}/visualization'.format(args.data_root, config['exp_dir'])
    ##########################################################
    config = edict(config)
