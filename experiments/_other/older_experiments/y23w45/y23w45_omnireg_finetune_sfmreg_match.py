...
if __name__ == '__main__':
    ...
    scene = "GreatCourt"
    points_A = np.load(f"data/colabsfm/{scene}_benchmark/pointclouds/test/{method}_cloud.npy") + 5
    viewpoints_A = np.load(f"data/colabsfm/{scene}_benchmark/pointclouds/test/{method}_viewpoints.npy") + 5
    points_B = np.load(f"data/colabsfm/{scene}_benchmark/pointclouds/test/{method}_cloud.npy")
    viewpoints_B = np.load(f"data/colabsfm/{scene}_benchmark/pointclouds/test/{method}_viewpoints.npy")
