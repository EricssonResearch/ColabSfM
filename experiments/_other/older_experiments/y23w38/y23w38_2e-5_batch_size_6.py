...
def train(args):
    ...
    dataloader = DataLoader(dataset, batch_size=batch_size, num_workers = 4, shuffle=True, collate_fn = collate_ragged)
    optimizer = AdamW(model.parameters(), lr = batch_size * 2e-5, weight_decay=1e-8)
