...
def main():
    ...
    config['snapshot_dir'] = "/tmp"#'{}/{}'.format(args.data_root, config['exp_dir'])
    config['tboard_dir'] = args.log_dir#'{}/{}/tensorboard'.format(args.data_root, config['exp_dir'])
    ...
    experiment_conf = edict(
        ...
        use_glue = True,
        glue_normalize_descriptors = False,
    )
