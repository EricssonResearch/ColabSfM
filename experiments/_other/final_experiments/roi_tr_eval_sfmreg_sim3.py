...
def main():
    ...
    if config.mode in ("val", "test"):
        # config.pretrain = "workspace/roi_tr_finetune_colabsfm_sim3/model_best_PIR.pth"
        config.pretrain = "pretrained/model_3dmatch.pth"
    elif config.mode == "train":
        # config.pretrain = "pretrained/model_3dmatch.pth"
        config.pretrain = "/proj/inter-op-slam/home/ejodhes/checkpoints/roi_tr_finetune_colabsfm_sim3/model_best_PIR.pth"
