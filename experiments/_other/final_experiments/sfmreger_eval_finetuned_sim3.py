...
def main():
    ...
    if config.mode in ("val", "test"):
        # config.pretrain = "workspace/y23w47_colabsfm_combined_lo_sim3/y23w47_colabsfm_combined_lo_sim3/model_best_PIR.pth"
        config.pretrain = 'workspace/y24w7_colabsfm_only_sim3/model_best_PIR.pth'
