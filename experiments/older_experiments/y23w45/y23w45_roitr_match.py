...
if __name__ == '__main__':
    ...
    import numpy as np
    points_A = np.load("data/sfmreg/pointclouds/0008/sift_cloud_0.npy")#np.load("data/sfmreg/lamar_benchmark/pointclouds/ios_2022-01-12_15.50.47_001/sfm_disk+lightglue_cloud.npy")#
    viewpoints_A = np.load("data/sfmreg/pointclouds/0008/sift_viewpoints_0.npy")#np.load("data/sfmreg/lamar_benchmark/pointclouds/ios_2022-01-12_15.50.47_001/sfm_disk+lightglue_viewpoints.npy")#
    points_B = np.load("data/sfmreg/pointclouds/0008/sift_cloud_1.npy")#np.load("data/sfmreg/lamar_benchmark/pointclouds/ios_2022-02-27_17.44.49_000/sfm_disk+lightglue_cloud.npy")#
    viewpoints_B = np.load("data/sfmreg/pointclouds/0008/sift_viewpoints_1.npy")#np.load("data/sfmreg/lamar_benchmark/pointclouds/ios_2022-02-27_17.44.49_000/sfm_disk+lightglue_viewpoints.npy")#
