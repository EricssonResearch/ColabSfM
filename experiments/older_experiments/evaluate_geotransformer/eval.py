...
from colabsfm.geotransformer.modules.registration import weighted_procrustes
...
from colabsfm.geotransformer.datasets.registration.threedmatch.utils import (
    get_num_fragments,
    get_scene_abbr,
