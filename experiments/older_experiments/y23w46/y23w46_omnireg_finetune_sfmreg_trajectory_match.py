...
def main(points_A, points_B, viewpoints_A = None, viewpoints_B = None, shared_scale = True):
    ...
    ######## Experiment settings ###########
    config.pretrain = "workspace/omnireg_sfmreg_finetuned_lo.pth"
...
if __name__ == '__main__':
    ...
    #points_A = np.load(f"data/sfmreg/pointclouds_trajectory/{scene}/{method}_cloud_trajectory_0.npy")
    #viewpoints_A = np.load(f"data/sfmreg/pointclouds_trajectory/{scene}/{method}_viewpoints_trajectory_0.npy")
    #points_B = np.load(f"data/sfmreg/pointclouds_trajectory/{scene}/{method}_cloud_trajectory_5.npy")
    #viewpoints_B = np.load(f"data/sfmreg/pointclouds_trajectory/{scene}/{method}_viewpoints_trajectory_5.npy")

    points_A = np.load(f"data/sfmreg/radiotower/CDU/{method}_cloud.npy")
    viewpoints_A = np.load(f"data/sfmreg/radiotower/CDU/{method}_viewpoints.npy")

    points_B = np.load(f"data/sfmreg/radiotower/TSO/{method}_cloud.npy")
    viewpoints_B = np.load(f"data/sfmreg/radiotower/TSO/{method}_viewpoints.npy")
    
    if False:
        pos_A = np.load(f"data/sfmreg/radiotower/CDU/{method}_projection_centers.npy")
        pos_B = np.load(f"data/sfmreg/radiotower/TSO/{method}_projection_centers.npy")
