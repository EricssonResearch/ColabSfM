...
if __name__ == '__main__':
    ...
    import numpy as np
    points_A = np.load("data/sfmreg/tum_benchmark/pointclouds/localization/sfm_disk+lightglue_cloud.npy")
    viewpoints_A = np.load("data/sfmreg/tum_benchmark/pointclouds/localization/sfm_disk+lightglue_viewpoints.npy")
    points_B = points_A#np.load("data/sfmreg/lamar_benchmark/pointclouds/ios_2022-02-27_17.44.49_000/sfm_disk+lightglue_cloud.npy")
    viewpoints_B = viewpoints_A#np.load("data/sfmreg/lamar_benchmark/pointclouds/ios_2022-02-27_17.44.49_000/sfm_disk+lightglue_viewpoints.npy")
