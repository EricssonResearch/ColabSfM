...
def main():
    ...
    if config.mode in ("val", "test"):
        # config.pretrain = ''#"pretrained/omnireg_lo_sfmreg_finetuned.pth"
        # config.pretrain = 'workspace/y24w7_sfmreg_3dmatch/model_best_PIR.pth'
        config.pretrain = 'workspace/y24w9_sfmreg_megadepth_color/model_best_PIR.pth'
    elif config.mode == "train":
        # config.pretrain = "pretrained/model_3dmatch.pth"
        # config.pretrain = "/proj/inter-op-slam/home/ejodhes/checkpoints/y24w7_sfmreg_3dmatch/y23w47_sfmreg_combined_lo/model_best_PIR.pth"
        # config.pretrain = '/proj/inter-op-slam/home/ejodhes/checkpoints/y24w9_sfmreg_megadepth_color/model_best_PIR.pth'
        config.pretrain = ''
