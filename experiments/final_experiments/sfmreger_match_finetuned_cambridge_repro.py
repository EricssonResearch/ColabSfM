...
from colabsfm.roitr.lib.loss import EvaluatorRegistration
...
def main():
    ...
    #points_A, points_B, viewpoints_A = None, viewpoints_B = None, shared_scale = True, gt = None
    ...
    ######## Experiment settings ###########
    #config.pretrain = "workspace/y23w47_sfmreg_combined_lo/y23w47_sfmreg_combined_lo/model_best_PIR.pth"
    # TODO: reeaally need to fix this hardcoding // johan
    config.pretrain = "data/sfmreg/models/sfmreg_finetuned.pth"
    # config.pretrain = 'workspace/y24w7_sfmreg_only/model_best_PIR.pth'
    # config.pretrain = 'pretrained/sfmreg.pth'
    ...
    for scene in scenes:
        ...
        points_B = np.load(data_root / scene_name/ "pointclouds"/ test/ f"{method}_cloud.npy")
        viewpoints_B = np.load(data_root / scene_name/ "pointclouds" / test / f"{method}_viewpoints.npy")
...
if __name__ == '__main__':
    ...
    main()    #os.environ["TORCHINDUCTOR_CACHE_DIR"] = "/tmp"
