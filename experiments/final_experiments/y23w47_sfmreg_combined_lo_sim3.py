...
def main():
    ...
    if config.mode in ("val", "test"):
        ...
        config.pretrain = 'workspace/y24w7_sfmreg_3dmatch_sim3/model_best_PIR.pth'
    elif config.mode == "train":
        # config.pretrain = "pretrained/model_3dmatch.pth"
        # config.pretrain = "/proj/inter-op-slam/home/ejodhes/checkpoints/y24w7_sfmreg_3dmatch_sim3/y23w47_sfmreg_combined_lo_sim3/model_best_PIR.pth"
        config.pretrain = ''
