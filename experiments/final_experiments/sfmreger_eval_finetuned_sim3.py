...
def main():
    ...
    if config.mode in ("val", "test"):
        # config.pretrain = "workspace/y23w47_sfmreg_combined_lo_sim3/y23w47_sfmreg_combined_lo_sim3/model_best_PIR.pth"
        config.pretrain = 'workspace/y24w7_sfmreg_only_sim3/model_best_PIR.pth'
