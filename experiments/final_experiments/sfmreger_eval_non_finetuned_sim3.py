...
from omnireg.roitr.lib.loss import OverallLoss, EvaluatorRegistration
...
def main():
    ...
    #config['root'] = args.data_root + ("/indoor" if config['dataset'] == "tdmatch" else "/sfmreg/pointclouds_trajectory")
