...
from omnireg.utils import to_tsfm, get_correspondences, vis_pointcloud_matplotlib, to_o3d_pcd, normal_redirect
...
class IndoorDataset(Dataset):
    ...
    def __getitem__(self,item):
        ...
        if(trans.ndim==1):
            trans=trans[:,None]
        from omnireg.utils import from_homogeneous, to_homogeneous
