...
from omnireg.utils import to_tsfm, get_correspondences, vis_pointcloud_matplotlib, to_o3d_pcd, normal_redirect, random_cut_pointclouds
import open3d as o3d
from time import perf_counter
import pickle as pkl

class SFMRegDataset(Dataset):
    """
    ...
    def __init__(self, infos, config, data_root = "data", pose_info = None, data_augmentation=False, overlap_threshold = 0.3):
        super(SFMRegDataset,self).__init__()
        ...
        self.mode = config.sfmreg_mode # aligned, sim3
