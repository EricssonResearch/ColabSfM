...
# from sfmreg.roitr.lib.utils import get_correspondences
...
class CoarseMatchingLoss(nn.Module):
    ...
    def forward(self, output_dict):
        ...
        if sfmreg.LOGGER is not None:
            sfmreg.LOGGER.add_scalars('data/roitr_train_loss', {"circle_loss": loss.item()}, global_step = sfmreg.GLOBAL_STEP)
        return loss
...
class OverallLoss(nn.Module):
    ...
    def forward(self, output_dict, data_dict):
        if 'src_node_feats' in output_dict:
            ...
            if sfmreg.LOGGER is not None:
                sfmreg.LOGGER.add_scalars('data/roitr_train_loss', {"fine_loss": fine_loss.item()}, global_step = sfmreg.GLOBAL_STEP)
