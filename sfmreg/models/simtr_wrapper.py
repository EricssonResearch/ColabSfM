...
from sfmreg.utils import get_correspondences, estimate_normals, transform
from sfmreg.benchmarks.benchmark_utils import to_array, to_o3d_pcd

class SimTr(nn.Module):
    def __init__(self, model, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.model = model
    
    @torch.inference_mode()
    def register(self, pointcloud_A, pointcloud_B, normals_A = None, normals_B = None, viewpoints_A = None, viewpoints_B = None, features_A = None, features_B = None, shared_scale = False):
